...
import { View, Text, StyleSheet, Dimensions, TouchableOpacity, Image, TextInput,FlatList,ActivityIndicator, ScrollView, TouchableWithoutFeedback } from 'react-native';
...
export default function ViewEnquiry({ route }) {
  ...
  React.useEffect(() => {
    ...
    console.log("hell" + JSON.stringify(item));
  }, [item.messages]);
  const getMessages = () => {
    fetch(
...
const onClose =()=>{
 ...
 <ScrollView showsVerticalScrollIndicator={false} style={{ marginBottom: 10 }}>
        ...
        {alertMessage !== '' && (
             <NeumorphicView >
              <View style={styles.neomorphAlert}>
...
<View style={{flex:1,alignItems:"center",justifyContent:"center",flexDirection:"column-reverse"}}>
  ...
  <NeumorphicText style={{fontSize:20,color:'red'}}>No messages found</NeumorphicText>
